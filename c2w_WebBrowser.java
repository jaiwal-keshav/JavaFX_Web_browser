...
c2w_webEngine.setConfirmHandler( str ->  impleDialogs.confirm(str, "Confirmation Needed").equals("yes") );
...
final c2w_BrowserWindow win = window; // (for use in a lambdaexpression
